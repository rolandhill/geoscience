...
#
    ...
    def createDownholePoints(self):
        ...
        atts.append(QgsField("CollarID", QMetaType.QString, "string", 16))
        atts.append(QgsField("Depth",  QMetaType.QDouble, "double", 12, 3))
        atts.append(QgsField("x",  QMetaType.QDouble, "double", 12, 3))
        atts.append(QgsField("y",  QMetaType.QDouble, "double", 12, 3))
        atts.append(QgsField("z",  QMetaType.QDouble, "double", 12, 3))
...
#        QgsProject.instance().addMapLayer(collar3D)
    ...
    def createDesurveyLayer(self):
        ...
        dp = layer.dataProvider()
        dp.addAttributes([
            QgsField("CollarID", QMetaType.QString, "string", 16),
            QgsField("SegLength",  QMetaType.QDouble, "double", 5, 2)
            ])
    ...
    def createDownholeIntervalLayer(self):
        ...
        for field in self.dataLayer.fields():
            if field.name() in self.dataFields:
                atts.append(field)
        # Also add fields for the desurveyed coordinates
        atts.append(QgsField("_From_x",  QMetaType.QDouble, "double", 12, 3))
        atts.append(QgsField("_From_y",  QMetaType.QDouble, "double", 12, 3))
        atts.append(QgsField("_From_z",  QMetaType.QDouble, "double", 12, 3))
        atts.append(QgsField("_To_x",  QMetaType.QDouble, "double", 12, 3))
        atts.append(QgsField("_To_y",  QMetaType.QDouble, "double", 12, 3))
        atts.append(QgsField("_To_z",  QMetaType.QDouble, "double", 12, 3))
        atts.append(QgsField("_Mid_x",  QMetaType.QDouble, "double", 12, 3))
        atts.append(QgsField("_Mid_y",  QMetaType.QDouble, "double", 12, 3))
        atts.append(QgsField("_Mid_z",  QMetaType.QDouble, "double", 12, 3))
    ...
    def createDownholePointLayer(self):
        ...
        for field in self.dataLayer.fields():
            if field.name() in self.dataFields:
                atts.append(field)
        # Also add fields for the desurveyed coordinates
        atts.append(QgsField("_Depth_x",  QMetaType.QDouble, "double", 12, 3))
        atts.append(QgsField("_Depth_y",  QMetaType.QDouble, "double", 12, 3))
        atts.append(QgsField("_Depth_z",  QMetaType.QDouble, "double", 12, 3))
    ...
    def createDownholeStructureLayer(self):
        ...
        atts.append(QgsField("_Depth_y",  QMetaType.QDouble, "double", 12, 3))
        atts.append(QgsField("_Depth_z",  QMetaType.QDouble, "double", 12, 3))
        atts.append(QgsField("_DipDir",  QMetaType.QDouble, "double", 12, 3))
        atts.append(QgsField("_Dip",  QMetaType.QDouble, "double", 12, 3))
        atts.append(QgsField("_Section_Dip",  QMetaType.QDouble, "double", 12, 3))
